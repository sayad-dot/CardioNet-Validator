...
def main():
    print("=== Verifying Original Dataset 2 ===")
    raw_path = os.path.join(os.getcwd(), "data", "dataset2.csv")
    raw_df = pd.read_csv(raw_path)
    # original column might be 'target' or 'heart disease'
    ...
    proc_path = os.path.join(os.getcwd(), "data", "processed", "clean_dataset2.csv")
    ...
    # save models
    save_dir = os.path.join('outputs', 'models_dataset2')
