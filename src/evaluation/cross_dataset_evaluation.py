...
def evaluate_model(model, X_test, y_test, model_name, test_name):
    print(f"\n--- {model_name} on {test_name} ---")
...
def cross_dataset_validation():
    ...
    for train_name in datasets:
        ...
        X_train, y_train = data[train_name]['X'], data[train_name]['y']

        # Identify test datasets and their data
        ...
        # Train models on standardized train set
